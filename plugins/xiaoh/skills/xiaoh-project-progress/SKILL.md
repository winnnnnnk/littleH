...
6. Ensure the project home links `项目进度.md` and carries the same update time and overall status. Update a global project overview only when it already exists and the same evidence supports the change.
